            ...
            <div class="col-6 col-md-2">
                <div class="align-end">
                    <select name="sort" id="sort" class="form-control">
                        <option value="1" {{ (Request::get('sort') == '1' || Request::get('sort') == '') ? 'selected' : '' }}>Latest</option>
                        ...
                        <div class="mb-4">
                            ...
                            @if ($jobTypes->isNotEmpty())
                                ...
                                <div class="form-check mb-2"> 
                                    <input {{ (in_array($jobType->id, explode(',', Request::get('jobType')))) ? 'checked' : '' }} class="form-check-input " name="job_type" type="checkbox" value="{{ $jobType->id }}" id="job-type-{{ $jobType->id }}">    
                ...
                <div class="job_listing_area">                    
                    <div class="job_lists">
                        <div class="row">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="bg-light p-3 border">
                                                ...
                                                <p class="mb-0">
                                                    ...
                                                    <span class="ps-1">{{ $job->jobType->name ?? 'Full Time' }}</span>
                                                </p>
                            ...
                            @else
                                <div class="col-md-12">
                                    <div class="card border-0 shadow py-5 text-center">
